...
function setup(): void
{
	exit('<BODY BGCOLOR="#000000"><center><img src="install/xrs-black.jpg"></center><br /><font color="Green"><center><h1>Silakan menuju <a href="./install/install.php">Halaman Instalasi</a></h1></center></font></body>');
}
